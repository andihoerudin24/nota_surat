    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <!-- /.box-header -->
          <?php echo form_open_multipart('Ajukan_surat/add') ?>
            <div class="box-body">
              <div class="row">
                <div class="col-xs-12">
                  <div class="form-group" style="margin-top:10px">
                    ...
                    <div class="col-xs-4">
                      <input class="form-control" type="text" id="onlynumber" name="kepada" maxlength="50" autofocus required />
                    </div>
                    <span class="col-xs-2" style="margin-left:10px; margin-bottom:15px; font-size:18px">Tembusan :</span>
                    <div class="col-xs-3">
                      <input class="form-control" type="text" id="onlynumber" name="tembusan" maxlength="11" autofocus required />
                ...
                <div class="col-xs-12" style="margin-top:10px">
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                      <input class="form-control" type="text" name="dari" maxlength="50" required />
                    </div>
                ...
                <div class="col-xs-12" style="margin-top:10px">
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                      <?php  echo cmb_dinamis('id_prihal','prihal','nama_prihal','id_prihal')  ?>
                    </div>
                  </div>
                </div>
